...
{
    public partial class VehicleListingDealType_Archive
    {
        public int VehicleListingDealType_ArchiveID { get; set; }
        public Nullable<int> VehicleListingDealTypeID { get; set; }
