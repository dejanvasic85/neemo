...
{
    public class KiloMeterMap : EntityTypeConfiguration<KiloMeter>
    {
        public KiloMeterMap()
        {
            // Primary Key
            this.HasKey(t => t.KilometerID);

            // Properties
            this.Property(t => t.KiloMeter1)
                .HasMaxLength(100);
            ...
            this.ToTable("KiloMeter");
            this.Property(t => t.KilometerID).HasColumnName("KilometerID");
            this.Property(t => t.KiloMeter1).HasColumnName("KiloMeter");
