...
{
    public class AncapRatingMap : EntityTypeConfiguration<AncapRating>
    {
        public AncapRatingMap()
        {
            // Primary Key
            this.HasKey(t => t.AncapRatingID);

            // Properties
            this.Property(t => t.AncapRating1)
                .HasMaxLength(100);
            ...
            this.ToTable("AncapRating");
            this.Property(t => t.AncapRatingID).HasColumnName("AncapRatingID");
            this.Property(t => t.AncapRating1).HasColumnName("AncapRating");
