...
namespace Neemo.CarParts.EntityFramework.Models.Mapping
{
    public class SeriesMap : EntityTypeConfiguration<Series>
    {
        public SeriesMap()
        {
            ...
            // Properties
            this.Property(t => t.Series1)
                .HasMaxLength(100);

            this.Property(t => t.SeriesShort)
                .HasMaxLength(100);
            ...
            this.Property(t => t.Series1).HasColumnName("Series");
            this.Property(t => t.SeriesShort).HasColumnName("SeriesShort");
