...
{
    public class VehicleListingMap : EntityTypeConfiguration<VehicleListing>
    {
        public VehicleListingMap()
        {
            // Primary Key
            this.HasKey(t => t.VehicleListingID);

            // Properties
            this.Property(t => t.VehicleListingID)
