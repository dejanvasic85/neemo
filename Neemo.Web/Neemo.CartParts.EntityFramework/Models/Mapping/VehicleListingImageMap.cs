...
{
    public class VehicleListingImageMap : EntityTypeConfiguration<VehicleListingImage>
    {
        public VehicleListingImageMap()
        {
            // Primary Key
            this.HasKey(t => t.VehicleListingImageID);
            ...
            this.ToTable("VehicleListingImage");
            this.Property(t => t.VehicleListingImageID).HasColumnName("VehicleListingImageID");
            ...
            this.HasOptional(t => t.VehicleListing)
                .WithMany(t => t.VehicleListingImages)
