...
{
    public class PPlateApproveMap : EntityTypeConfiguration<PPlateApprove>
    {
        public PPlateApproveMap()
        {
            // Primary Key
            this.HasKey(t => t.PPlateApproveID);

            // Properties
            this.Property(t => t.PPlateApprove1)
                .HasMaxLength(100);
            ...
            this.ToTable("PPlateApprove");
            this.Property(t => t.PPlateApproveID).HasColumnName("PPlateApproveID");
            this.Property(t => t.PPlateApprove1).HasColumnName("PPlateApprove");
