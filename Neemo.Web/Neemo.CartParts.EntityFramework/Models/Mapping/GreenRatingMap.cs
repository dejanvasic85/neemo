...
{
    public class GreenRatingMap : EntityTypeConfiguration<GreenRating>
    {
        public GreenRatingMap()
        {
            // Primary Key
            this.HasKey(t => t.GreenRatingID);

            // Properties
            this.Property(t => t.GreenRating1)
                .HasMaxLength(100);
            ...
            this.ToTable("GreenRating");
            this.Property(t => t.GreenRatingID).HasColumnName("GreenRatingID");
            this.Property(t => t.GreenRating1).HasColumnName("GreenRating");
